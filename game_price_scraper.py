...
### ------- BEGIN CONSTANTS -------- ###
# List of only the games PC_ID that I wish to find prices for:
# PC_ID_LIST = ['19745',
#               '21626',
#               '36213',
#               '16424',
...
def scrape_console_prices(curr_console: str) -> pd.DataFrame:
    ...
    ##### ----- BEGIN CODE FOR NORMAL USE ----- #####
    # Obtain all row data in the #games_table from the website:
    game_data_row = console_scraper.driver.find_elements(
        By.CSS_SELECTOR, "#games_table tbody tr")
    ##### ----- END CODE FOR NORMAL USE ----- #####

    ##### ----- BEGIN CODE FOR IF YOU ARE USING PC_ID_LIST ----- #####
    # Obtain all row data in the #games_table that match on the
    # the PC_ID_LIST from the website:
    ...
    ##### ----- END CODE FOR IF YOU ARE USING PC_ID_LIST ----- #####
